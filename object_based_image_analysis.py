...
# %% [markdown]
# put pixels in same segment only if in the same segment in all
# bands. We do this by combining the band segmentation 
# to one number
...
with rio.open('class.tif', 'w', **naip_meta) as dst:
    dst.write(clf.astype('int8'), 1)
